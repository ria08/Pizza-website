...
<script type="text/javascript">
  $(document).ready(function(){
      $.ajax({
        ...
        type:'GET',
        data:"type=Non-Veg&&category=Pizza",
        beforeSend:function(){
...
<body>
  ...
  <section id="non_veg_pizza">
    <div class="container border">
      <h1 class="display-4 text-center text-primary">Non Veg Pizza</h1>
